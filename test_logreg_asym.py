...
test_vec = pd.read_csv('datasets/bless2011/data_lex_test_vectorized_asym.tsv', sep='\t', header=None)
val_vec = pd.read_csv('datasets/bless2011/data_lex_val_vectorized_asym.tsv', sep='\t', header=None)
