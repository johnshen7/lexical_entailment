...
train = pd.read_csv('../datasets/bless2011/data_lex_train_vectorized_cosine.tsv', sep='\t', header=None)
test = pd.read_csv('../datasets/bless2011/data_lex_test_vectorized_cosine.tsv', sep='\t', header=None)
